...
namespace TestAssignment
{
    public partial class Screen2 : Form
    {
        ...
        SqlConnection con = new SqlConnection("Data Source=LAPTOP-KVD34J7A;Initial Catalog=SurveyDB;Integrated Security=True;Connect Timeout=30;Encrypt=False;TrustServerCertificate=False;ApplicationIntent=ReadWrite;MultiSubnetFailover=False");
        ...
        {          
            ...
            {
                MessageBox.Show("Not able to Add Personal Details");
          ...
          if (validate <= 5 || validate >= 120)
            ...
            else if(!System.Text.RegularExpressions.Regex.IsMatch(txtSurname.Text, "^[a-zA-Z]"))
            {
